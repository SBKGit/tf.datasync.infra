...
def handler(event, context):
    ...
    # start the EC2 instances in the Auto Scaling group
    if instance_ids:
    ...
    # Un-Suspend health checks for the Auto Scaling group
    ...
    if response['ResponseMetadata']['HTTPStatusCode'] == 200:
        print(f"Health checks un-suspended for Auto Scaling group: {auto_scaling_group_name}")
